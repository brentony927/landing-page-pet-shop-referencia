...
const slides = [
  {
    img: heroSlide1,
    title: "Banho e tosa sem stress, do jeitinho dele",
    sub: "12 anos cuidando dos pets do bairro, um por um",
    cta: "Agendar banho",
    accent: "#F5851F",
    badge: "5.000+ pets já passaram por aqui",
  },
  {
    img: heroSlide2,
    title: "Aquela ração que ele come até o último grão",
    sub: "Marcas que a gente usa nos nossos próprios bichos",
    cta: "Ver produtos",
    accent: "#F5851F",
    badge: "Indicação de quem entende",
  },
  {
    img: heroSlide5,
    title: "Catálogo com preço de bairro",
    sub: "Rações, petiscos e acessórios sem enrolação",
    cta: "Ver catálogo",
    accent: "#FFB300",
  ...
  {
    img: heroSlide3,
    title: "Pediu, chegou. Sem taxa, sem demora",
    sub: "Entregamos a ração na sua porta no mesmo dia",
    cta: "Pedir agora",
    accent: "#22A66E",
    badge: "Entrega em menos de 1h",
  },
];
