...
const photos = [
  { badge: "Antes", badgeColor: "var(--pet-blue)", alt: "Pet antes do banho e tosa" },
  { badge: "Depois ✨", badgeColor: "var(--pet-orange)", alt: "Pet após banho e tosa" },
  { badge: "Nossa loja", badgeColor: "var(--pet-yellow-dark)", alt: "Estrutura da Pet Shop Amazônia" },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {photos.map((photo, i) => (
            <div
              ...
              style={{ background: i === 1 ? "var(--pet-orange-light)" : "var(--pet-blue-light)", border: `1.5px solid ${i === 1 ? "var(--pet-orange)" : "var(--pet-blue)"}`, boxShadow: "0 8px 32px rgba(0,0,0,0.06)" }}
