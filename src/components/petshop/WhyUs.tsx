...
const stats = [
  { number: 5000, suffix: "+", label: "banhos por ano", icon: Bath, bg: "bg-secondary/15" },
  { number: 12, suffix: " anos", label: "cuidando de pets", icon: Heart, bg: "bg-primary/10" },
  { number: 4.8, suffix: "", label: "nota no Google", icon: Star, bg: "bg-accent/15" },
];
