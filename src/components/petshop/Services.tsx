  ...
  return (
    <section id="servicos" className="py-16 md:py-20 px-4" style={{ background: "var(--pet-bg)" }}>
      <div className="max-w-[1100px] mx-auto">
        <h2 className="text-2xl md:text-[2rem] font-extrabold leading-tight mb-10" style={{ fontFamily: "'Baloo 2', cursive", color: "var(--pet-blue-dark)" }}>
          🐾 Nossos serviços
        </h2>

        <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
          {/* Card principal - LARANJA */}
          <div
            className="md:col-span-7 relative rounded-3xl p-8 md:p-10 overflow-hidden cursor-pointer transition-all duration-300"
            style={{ background: "var(--pet-orange-light)", border: "2px solid var(--pet-orange)", boxShadow: "0 8px 32px rgba(255,138,101,0.12)" }}
            onMouseEnter={(e) => { e.currentTarget.style.transform = "translateY(-4px)"; e.currentTarget.style.boxShadow = "0 16px 40px rgba(255,138,101,0.25)"; }}
            onMouseLeave={(e) => { e.currentTarget.style.transform = "none"; e.currentTarget.style.boxShadow = "0 8px 32px rgba(255,138,101,0.12)"; }}
          >
            <span className="absolute top-0 right-6 text-white text-[10px] font-extrabold uppercase tracking-wider px-3 py-1 rounded-b-md" style={{ background: "var(--pet-orange)" }}>
              Mais pedido
            </span>
            <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-5" style={{ background: "var(--pet-orange)" }}>
            ...
            <p className="text-sm font-extrabold mb-6" style={{ color: "var(--pet-orange-dark)" }}>
          ...
          <div className="md:col-span-5 flex flex-col gap-4">
            ...
            <div
              ...
              style={{ border: "1.5px solid var(--pet-blue)", boxShadow: "0 8px 32px rgba(66,165,245,0.08)" }}
              onMouseEnter={(e) => { e.currentTarget.style.transform = "translateY(-3px)"; e.currentTarget.style.boxShadow = "0 12px 30px rgba(66,165,245,0.15)"; }}
              onMouseLeave={(e) => { e.currentTarget.style.transform = "none"; e.currentTarget.style.boxShadow = "0 8px 32px rgba(66,165,245,0.08)"; }}
            >
            ...
            {/* Rações - AMARELO */}
            <div
              className="rounded-3xl p-6 cursor-pointer transition-all duration-300"
              style={{ background: "var(--pet-yellow-light)", border: "1.5px solid var(--pet-yellow)", boxShadow: "0 8px 32px rgba(255,193,7,0.08)" }}
              onMouseEnter={(e) => { e.currentTarget.style.transform = "translateY(-3px)"; e.currentTarget.style.boxShadow = "0 12px 30px rgba(255,193,7,0.18)"; }}
              onMouseLeave={(e) => { e.currentTarget.style.transform = "none"; e.currentTarget.style.boxShadow = "0 8px 32px rgba(255,193,7,0.08)"; }}
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href={WA_LINK} target="_blank" rel="noopener noreferrer" className="text-sm font-bold hover:underline" style={{ color: "var(--pet-orange)" }}>Pedir pelo WhatsApp →</a>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              style={{ background: "var(--pet-blue)", boxShadow: "0 8px 32px rgba(66,165,245,0.2)" }}
              onMouseEnter={(e) => { e.currentTarget.style.transform = "translateY(-3px)"; e.currentTarget.style.boxShadow = "0 16px 40px rgba(66,165,245,0.35)"; }}
              onMouseLeave={(e) => { e.currentTarget.style.transform = "none"; e.currentTarget.style.boxShadow = "0 8px 32px rgba(66,165,245,0.2)"; }}
            >
        ...
        <div className="mt-12 text-center">
          <a
            ...
            style={{ background: "var(--pet-orange)", color: "#fff", boxShadow: "0 4px 14px rgba(255,138,101,0.4)" }}
          >
