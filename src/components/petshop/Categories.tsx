...
const topRow = [
  { label: "Cachorro", icon: Dog, color: "var(--amber)", bg: "var(--amber-light)", subs: ["Ração Seca", "Ração Úmida", "Petiscos", "Brinquedos", "Coleiras", "Camas"] },
  { label: "Gato", icon: Cat, color: "#7c3aed", bg: "#f5f3ff", subs: ["Ração Seca", "Ração Úmida", "Areia Higiênica", "Arranhadores", "Brinquedos"] },
  { label: "Rações", icon: Bone, color: "var(--forest)", bg: "var(--forest-light)", subs: ["Premium", "Super Premium", "Natural", "Filhotes", "Adultos", "Idosos"] },
  { label: "Petiscos", icon: Drumstick, color: "var(--amber)", bg: "var(--amber-light)", subs: ["Bifinhos", "Ossos", "Dental", "Snacks", "Biscoitos"] },
...
const bottomRow = [
  ...
  { label: "Serviços", icon: Sparkles, color: "var(--forest)", bg: "var(--forest-light)", subs: ["Banho & Tosa", "Veterinário", "Táxi Pet"] },
];
...
const quickServices = [
  ...
  { icon: Heart, title: "Adote um Pet", color: "var(--forest)", bg: "var(--forest-light)" },
  { icon: Truck, title: "Entrega Rápida", color: "var(--amber)", bg: "var(--amber-light)" },
];
  ...
  return (
    <div className="relative" onMouseEnter={onEnter} onMouseLeave={onLeave}>
      <button
        ...
        style={{ background: isActive ? cat.bg : "var(--cream)" }}
      >
        <div
          className="w-12 h-12 rounded-full flex items-center justify-center transition-all duration-200"
          style={{ background: isActive ? `${cat.color}18` : "var(--cream-dark)" }}
        >
      ...
      <section className="py-8 px-4 bg-white">
        ...
        {activeCategory && (
          <div
            ...
            style={{ borderColor: "var(--border)", boxShadow: "0 8px 24px rgba(0,0,0,0.08)" }}
          ...
          >
            <div className="px-5 py-4">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-sm font-bold" style={{ color: "var(--txt-primary)" }}>{activeCategory.label}</h3>
              </div>
              <div className="flex flex-wrap gap-2">
                {activeCategory.subs.map(sub => (
                  <Link
                    ...
                    style={{ background: "var(--cream)", color: "var(--txt-secondary)" }}
                    onMouseEnter={(e) => { e.currentTarget.style.background = activeCategory.bg; e.currentTarget.style.color = activeCategory.color; }}
                    onMouseLeave={(e) => { e.currentTarget.style.background = "var(--cream)"; e.currentTarget.style.color = "var(--txt-secondary)"; }}
                  >
                    {sub}
                  </Link>
                ))}
            ...
            {quickServices.map((s) => {
              ...
              return (
                <div
                  ...
                  style={{
                    background: isHovered ? s.bg : "var(--cream)",
                ...
                >
                  ...
                  <span className="text-sm font-semibold" style={{ color: isHovered ? s.color : "var(--txt-secondary)" }}>{s.title}</span>
                </div>
              );
            })}
          </div>
