...
const navCategories = [
  { label: "Cachorro", icon: Dog, subs: ["Ração Seca", "Ração Úmida", "Petiscos", "Brinquedos", "Coleiras", "Camas"] },
  { label: "Gato", icon: Cat, subs: ["Ração Seca", "Ração Úmida", "Areia Higiênica", "Arranhadores", "Brinquedos"] },
  { label: "Rações", icon: Bone, subs: ["Premium", "Super Premium", "Natural", "Filhotes", "Adultos", "Idosos"] },
  { label: "Petiscos", icon: Drumstick, subs: ["Bifinhos", "Ossos", "Dental", "Snacks", "Biscoitos"] },
  { label: "Higiene", icon: Bath, subs: ["Shampoo", "Condicionador", "Perfume", "Lenços", "Tapete Higiênico"] },
  { label: "Farmácia", icon: Pill, subs: ["Antipulgas", "Vermífugos", "Vitaminas", "Suplementos"] },
  { label: "Brinquedos", icon: Gamepad2, subs: ["Mordedores", "Bolinhas", "Pelúcia", "Interativos", "Cordas"] },
  { label: "Acessórios", icon: Watch, subs: ["Coleiras", "Guias", "Roupas", "Comedouros", "Caixas de Transporte"] },
  { label: "Promoções", icon: Tag, subs: ["Até 30% off", "Combos", "Leve 3 Pague 2", "Queima de Estoque"] },
  { label: "Serviços", icon: Sparkles, subs: ["Banho & Tosa", "Veterinário", "Táxi Pet", "Hotel Pet"] },
];
              ...
              >
                ...
                >
                  ...
                  <span
                    ...
                    style={{ width: isActive ? "60%" : "0%", background: "#16a34a" }}
                  />
                </button>
              </div>
            );
          ...
          >
            <div className="max-w-[1100px] mx-auto px-5 py-5">
              <div className="flex items-center gap-2 mb-3">
                {activeCategory.icon && <activeCategory.icon className="w-4 h-4" style={{ color: "#16a34a" }} />}
              ...
              return (
                ...
                >
                  ...
                  <span
                    ...
                    style={{ fontFamily: "'DM Sans', sans-serif", color: isHovered ? s.color : "#1c1917" }}
                  >
                    {s.title}
                  </span>
                </div>
