...
const WA_LINK = "https://wa.me/5569992216764?text=" + encodeURIComponent("Olá! Vi o site de vocês e gostaria de agendar um serviço para o meu pet. Podem me ajudar?");
...
const WhatsAppButton = () => {
  ...
  return (
    <div className="fixed bottom-24 sm:bottom-5 right-4 sm:right-6 z-[999] hidden sm:block">
      {showBubble && (
        <div
