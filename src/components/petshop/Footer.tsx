...
const Footer = () => {
  return (
    <footer style={{ background: "var(--pet-blue-dark)" }}>
      <div className="max-w-[1100px] mx-auto px-4 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          <div>
            <div className="flex items-center gap-2 mb-3">
              <div className="w-9 h-9 rounded-full flex items-center justify-center" style={{ background: "var(--pet-orange)" }}>
            ...
            <div className="flex gap-2 mt-4">
              {[Instagram, Facebook, MessageCircle].map((Icon, i) => (
                <a key={i} href="https://wa.me/5569992216764" className="w-9 h-9 rounded-full flex items-center justify-center transition-all duration-200 text-white/60 hover:text-white" style={{ background: "rgba(255,138,101,0.2)" }}
                  onMouseEnter={(e) => e.currentTarget.style.background = "var(--pet-orange)"}
                  onMouseLeave={(e) => e.currentTarget.style.background = "rgba(255,138,101,0.2)"}
                >
          ...
          <div>
            <h4 className="text-xs uppercase tracking-widest mb-4 font-bold" style={{ color: "var(--pet-orange)" }}>Serviços</h4>
          ...
          <div>
            <h4 className="text-xs uppercase tracking-widest mb-4 font-bold" style={{ color: "var(--pet-orange)" }}>Atendimento</h4>
          ...
          <div>
            <h4 className="text-xs uppercase tracking-widest mb-4 font-bold" style={{ color: "var(--pet-orange)" }}>Agendar</h4>
