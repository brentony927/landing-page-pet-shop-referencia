      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 max-w-5xl mx-auto">
          <div className="space-y-4 md:space-y-5">
            <div className="bg-background border border-border rounded-lg p-5 flex items-start gap-4 transition-all duration-200 hover:border-secondary hover:shadow-sm">
            ...
            <div className="bg-background border border-border rounded-lg p-5 flex items-start gap-4 transition-all duration-200 hover:border-primary hover:shadow-sm">
              <div className="bg-muted rounded-lg p-3 flex-shrink-0">
            ...
            <div className="bg-background border border-border rounded-lg p-5 transition-all duration-200 hover:border-secondary hover:shadow-sm">
              <p className="text-foreground font-bold text-sm mb-2">Localização</p>
          ...
          <div className="bg-background rounded-lg p-6 md:p-8 shadow-[0_2px_24px_rgba(0,0,0,0.08)]">
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              ...
              <button className="w-full bg-primary text-primary-foreground font-bold rounded-md text-sm md:text-base uppercase tracking-wider py-3.5 md:py-4 hover:-translate-y-0.5 hover:shadow-[0_6px_20px_hsl(18_100%_59%/0.35)] transition-all duration-200">
                Enviar mensagem
              </button>
            </form>
          </div>
