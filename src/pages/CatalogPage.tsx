...
const allProducts: Product[] = [
  ...
  // ─── PÁSSAROS ───
  {
    name: "Ração para Canários Club Alcon",
    brand: "Alcon",
    rating: 4.8,
    cat: "birds",
    weight: "325g",
    ...
    desc: "Ração completa para canários com seleção equilibrada de sementes e nutrientes essenciais.",
    benefits: ["Sementes selecionadas", "Estimula o canto", "Rico em nutrientes", "Alta aceitação"],
  },
  {
    name: "Ração para Curió Club Alcon",
    brand: "Alcon",
    rating: 4.9,
    popular: true,
    cat: "birds",
  ...
  {
    name: "Ração para Papagaio Mix Megazoo",
    brand: "Megazoo",
    rating: 4.5,
    cat: "birds",
    weight: "350g",
  ...
  {
    name: "Ração para Papagaio com Frutas e Legumes Megazoo",
    brand: "Megazoo",
    rating: 4.1,
    cat: "birds",
    weight: "600g",
  ...
  // ─── PEIXES ───
  {
    ...
    recommendation: "Ofereça 2 a 3 vezes ao dia em pequenas porções, sem sobras no aquário.",
    images: [tetraColorbitsImg],
    desc: "Granulado para peixes tropicais que ajuda a realçar as cores naturais com alta digestibilidade.",
    benefits: ["Realça cores", "Alta digestão", "Não turva água", "Uso diário"],
  },
  {
    name: "Ração Mini Betta Alcon",
    brand: "Alcon",
    rating: 4.5,
    cat: "fish",
    weight: "10g",
    ...
    age: "Adulto",
    size: "Peixes Betta",
    recommendation: "Ofereça 2x ao dia em pequenas quantidades. Remova sobras para manter a água limpa.",
    images: [alconMiniBettaImg],
    desc: "Alimento granulado para peixes Betta com tamanho adequado e boa aceitação.",
    benefits: ["Grãos pequenos", "Boa aceitação", "Água limpa", "Nutrição diária"],
  },
  {
    name: "Ração Tetra Color Flakes",
    brand: "Tetra",
    rating: 4.9,
    cat: "fish",
    weight: "20g",
    ...
    age: "Adulto",
    size: "Peixes tropicais",
    recommendation: "Ofereça 2 vezes ao dia a quantidade consumida em poucos minutos.",
    images: [tetraColorFlakesImg],
    desc: "Flocos de alta qualidade para peixes tropicais com foco em cor, vitalidade e digestão.",
    benefits: ["Flocos premium", "Cores mais vivas", "Alta digestão", "Boa flotação"],
  },
  {
    name: "Ração Bettamix Alcon",
    brand: "Alcon",
    rating: 5.0,
    cat: "fish",
    weight: "10g",
    ...
    age: "Adulto",
    size: "Peixes Betta",
    recommendation: "Alimento diário para Bettas. Sirva pequenas porções e evite excesso.",
    images: [alconBettamixImg],
    desc: "Ração multivitaminada para Betta com nutrientes importantes para energia e coloração.",
    benefits: ["Multivitaminada", "Boa aceitação", "Cores vibrantes", "Fácil de servir"],
  },
];
